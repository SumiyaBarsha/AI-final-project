...
#         self.lab.pack(expand = True,side=CENTER , anchor=NW)
...
class maze:
    ...
    def CreateMaze(self,x=1,y=1,pattern=None,loopPercent=0,saveMaze=False,theme:COLOR=COLOR.dark):
        '''
        ...
        agent(self,*self._goal,shape='square',color=COLOR.green)
        if saveMaze:
